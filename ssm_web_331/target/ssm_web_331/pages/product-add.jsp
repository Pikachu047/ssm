...
<meta
	...
	<script charset="utf-8" src="${pageContext.request.contextPath}/plugins/kindeditor/kindeditor-min.js"></script>
	...
	<script type="text/javascript">
		...
		KindEditor.ready(function(K) {
			editor = K.create('textarea[name="content"]', {
				...
				uploadJson : '${pageContext.request.contextPath}/plugins/kindeditor/jsp/upload_json.jsp',
				fileManagerJson : '${pageContext.request.contextPath}/plugins/kindeditor/jsp/file_manager_json.jsp'
			});
		});
